...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/taylordunn/tdunn-cv/raw/master/tdunn-cv.pdf)")
}
```
...
The source code is available [on github.com/nstrayer/cv](https://github.com/taylordunn/tdunn-cv).
