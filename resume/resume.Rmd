...
projects <- tribble(
  ...
  "Halifax bike ridership", "2022",
  c("An end-to-end machine learning project to predict daily bike ridership in Halifax, Nova Scotia.
    \\begin{itemize}
      \\item Deployed on Google Cloud Platform.
    \\end{itemize}"),
  "https://github.com/taylordunn/hfx-bike-ridership",
  "Canadian COVID-19 dashboard", "2022", "A dashboard built in Shiny that reports and visualizes the latest COVID-19 numbers in Canada.", "\\bodyfontlight\\color{tdunn-blue}\\href{https://taylor-dunn.shinyapps.io/canadacovidshiny/}{https://taylor-dunn.shinyapps.io/canadacovidshiny/}",
